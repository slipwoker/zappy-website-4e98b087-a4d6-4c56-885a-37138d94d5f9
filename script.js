    ...
    if (contactForm) {
        ...
        function validateField(field) {
            ...
            if (value !== '') {
                ...
                if (field.tagName === 'TEXTAREA' && value.length < 10 && isRequired) {
            ...
            if (isValid) {
                ...
                .then(function(response) {
                    if (response.ok) {
                        contactForm.reset();
                        fields.forEach(function(field) {
                            field.classList.remove(successClass, errorClass);
                        });
                ...
                .catch(function(error) {
                    const existingMessages = contactForm.querySelectorAll('.error-message');
                    existingMessages.forEach(function(msg) { msg.remove(); });
        ...
        contactForm.addEventListener('input', function(e) {
            ...
            if (existingError && field.classList.contains(errorClass)) {
                validateField(field);
            }
        });
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '4e98b087-a4d6-4c56-885a-37138d94d5f9',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '4e98b087-a4d6-4c56-885a-37138d94d5f9';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '4e98b087-a4d6-4c56-885a-37138d94d5f9';
